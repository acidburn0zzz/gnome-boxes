...
private class Boxes.PropertiesSnapshots: Boxes.PropertiesPageWidget {
    ...
    public PropertiesSnapshots (LibvirtMachine machine) {
        ...
        var change = new DeferredChange ("snapshots-disconnect", (owned) on_flushed);
        add_deferred_change (change);
